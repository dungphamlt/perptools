...
import Onyx from "../assets/images/Onyx.svg";
import Twitter from "../assets/icons/twitter.svg?react";
import Discord from "../assets/icons/discord.svg?react";
import DexOrderly from "../assets/icons/dex-orderly.svg?react";
    ...
    return (
      <div className="p-6 rounded-2xl border border-primary/40">
        <div className="flex justify-between items-center mb-8">
          <span className="text-white text-2xl font-medium">{`NFT Sale ${selectedNft}`}</span>
          <a
            href="#"
            className="border border-primary font-medium flex items-center gap-1 px-3 py-1 hover:bg-primary transition-all duration-300 text-primary hover:text-black rounded-lg"
          >
            <span>Contract</span>
        ...
        <button className="w-full py-3 text-center text-lg font-medium rounded-lg bg-gradient-to-b from-[#2BB9F3] to-[#83D4FB] text-black hover:bg-gradient-to-b hover:from-primary hover:to-primary transition-all duration-300 cursor-pointer">
          Connect Wallet
        </button>
  ...
  return (
    <div>
      <div className="container mx-auto pt-6 pb-10">
        ...
        <div className="flex justify-between gap-10 px-16 mt-8">
          <div className="w-5/12">
            ...
            <div className="grid grid-cols-3 gap-4">
              {nftSaleData.map((nft) => (
                <div
                  key={nft.name}
                  className={`cursor-pointer rounded-3xl overflow-hidden hover:scale-105 transition-all duration-300 hover:border-2 hover:border-primary ${
          ...
          <div className="w-7/12">
            <RenderNftMintCard />
            {/* Overview */}
            <div className="border border-primary/40 rounded-lg p-6 my-6 bg-black">
